    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="link-dashboard hidden space-x-8 sm:-my-px sm:ms-10 sm:flex bg-none">
                    <a href="{{route('dashboard')}}" :active="request()->routeIs('dashboard')" class="nounderlin pt-2 ">
                        <h3 class="text-white bg-none no-underline text-sm pt-3">Dashboard</h3>
                    </a>
                </div>
            </div>
