                                                ...
                                                <form  method="post" action="{{ route('cuti.store') }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                                        <div>
                                                            ...
                                                            <input type="text" name="NIP" id="NIP" placeholder="NIP" class="col-span-3">
                                                        </div>
                                                        <div>
                                                          <label for="nama" class="col-span-3">Nama:</label>
                                                          <input type="text" name="nama_employee" id="nama" placeholder="Nama" class="col-span-3">
                                                        </div>
                                                        <div>
                                                            <label for="nama" class="col-span-3">Tanggal Mulai:</label>
                                                            <input type="date" name="tanggal_mulai" id="tanggal_mulai" placeholder="" class="col-span-3">
                                                          </div>
                                                        <div>
                                                          <label for="alamat" class="col-span-3">Tanggal Selesai:</label>
                                                          <input type="date" name="tanggal_selesai" id="tanggal_selesai" placeholder="" class="col-span-3">
                                                        </div>
                                                        <div>
                                                          <label for="jenis_cuti" class="col-span-3">Jenis Cuti:</label>
                                                          <select name="jenis_cuti" id="lang" class="col-span-3">
                                                      ...
                                                      <tr class="border-b border-opacity-20 dark:border-gray-700 dark:bg-gray-200">
                                                        ...
                                                        <td class="p-3 text-right">
                                                            <div class="flex flex-row gap-4 items-center">
                                                                <form class="dark:text-gray-100" id="deleteForm{{$cuties->id}}" method="post" action="{{route('cuti.destroy',['cuti' => $cuties->id])}}">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="onclick="confirmDelete({{$cuties->id}})">Delete</button>
                                                                </form>
                                                                <a href="{{ route('cuti.edit', ['cuti' => $cuties]) }}">
                                                                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" value="{{$cuties->id}}">Edit</button>
                                                                </a>
                                                            </div>
                                                        </td>
                                                      </tr>
